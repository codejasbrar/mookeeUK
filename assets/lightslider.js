            ...
            pager: function() {
                ...
                if (z.createPager = function() {
                        ...
                        for (d = 0; c > d; d++) {
							...
							var j = b.eq(d * e.slideMove).attr("data-alt");
                            if (f += e.gallery === !0 ? '<li style="width:100%;' + r + ":" + w + "px;" + s + ":" + e.thumbMargin + 'px" class="img__thumb ' + j + '" ><a href="#"><img src="' + i + '" alt="' + j + '" class="thumb__img"/></a></li>' : '<li><a href="#">' + (d + 1) + "</a></li>", "slide" === e.mode && h >= m - o - e.slideMargin) {
                                d += 1;
                                var j = 2;
